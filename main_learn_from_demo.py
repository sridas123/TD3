...
if __name__ == "__main__":
    ...
    replay_buffer_demo=utils.ReplayBuffer(state_dim, action_dim)
    
    #Load the demonstrations from the numpy file
    ...
    for t in range(int(args.max_timesteps)):
        ...
        if t >= args.start_timesteps:
            policy.train(replay_buffer,replay_buffer_demo, False, args.batch_size)
